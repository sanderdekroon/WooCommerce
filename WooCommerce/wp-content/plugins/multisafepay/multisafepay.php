        ...
        class WC_MULTISAFEPAY extends WC_Payment_Gateway {
            ...
            function checkout_button() {
                if (get_woocommerce_currency() == 'EUR') {
                    ...
                    echo '<a class="checkout-button"  style="width:150px;float: right;clear: both;margin-bottom:5px;margin-top:5px;" href="' . add_query_arg('action', 'doFastCheckout', add_query_arg('wc-api', 'WC_MULTISAFEPAY', home_url('/'))) . '">';
                    echo "<img src='" . $image . "' style='vertical-align: center;width: 150px;border-radius: 0px;box-shadow: none;padding: 0px;' border='0' alt='" . __('Pay with FastCheckout', 'multisafepay') . "'/>";
                    echo "</a>";
                    echo '</div>';
                }
            }
