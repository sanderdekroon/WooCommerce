...
/*
  Plugin Name: Multisafepay FERBUY
...
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins'))) || is_plugin_active_for_network('woocommerce/woocommerce.php')) {
    add_action('plugins_loaded', 'WC_MULTISAFEPAY_FERBUY_Load', 0);

    function WC_MULTISAFEPAY_FERBUY_Load() {

        class WC_MULTISAFEPAY_FERBUY extends WC_Payment_Gateway {
            ...
            public function __construct() {
                ...
                $this->id = "multisafepay_ferbuy";

                $this->has_fields = false;
                $this->paymentMethodCode = "FERBUY";
                $this->supports = array(
                    /* 'subscriptions',
                      'products',
                ...
                add_filter('woocommerce_payment_gateways', array('WC_MULTISAFEPAY_FERBUY', 'MULTISAFEPAY_FERBUY_Add_Gateway'));
            ...
            public static function MULTISAFEPAY_FERBUY_Add_Gateway($methods) {
                global $woocommerce;
                $methods[] = 'WC_MULTISAFEPAY_FERBUY';
