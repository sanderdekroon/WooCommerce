...
/*
  Plugin Name: Multisafepay Maestro
...
if ($activate_plugin) {
    ...
    if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
        add_action('plugins_loaded', 'WC_MULTISAFEPAY_MAESTRO_Load', 0);

        function WC_MULTISAFEPAY_MAESTRO_Load() {

            class WC_MULTISAFEPAY_MAESTRO extends WC_Payment_Gateway {
                ...
                public function __construct() {
                    ...
                    $this->id = "MULTISAFEPAY_MAESTRO";

                    $this->has_fields = false;
                    $this->paymentMethodCode = "MAESTRO";
                    $this->supports = array(
                        /* 'subscriptions',
                          'products',
                    ...
                    add_filter('woocommerce_payment_gateways', array('WC_MULTISAFEPAY_MAESTRO', 'MULTISAFEPAY_MAESTRO_Add_Gateway'));
                ...
                public static function MULTISAFEPAY_MAESTRO_Add_Gateway($methods) {
                    global $woocommerce;
                    $methods[] = 'WC_MULTISAFEPAY_MAESTRO';
