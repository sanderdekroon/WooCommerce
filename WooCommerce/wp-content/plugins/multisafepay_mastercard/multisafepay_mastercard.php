...
/*
  Plugin Name: Multisafepay MasterCard
...
if ($activate_plugin) {
    ...
    if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
        add_action('plugins_loaded', 'WC_MULTISAFEPAY_MASTERCARD_Load', 0);

        function WC_MULTISAFEPAY_MASTERCARD_Load() {

            class WC_MULTISAFEPAY_MASTERCARD extends WC_Payment_Gateway {
                ...
                public function __construct() {
                    ...
                    $this->id = "MULTISAFEPAY_MASTERCARD";
                ...
                public static function MULTISAFEPAY_MASTERCARD_Add_Gateway($methods) {
                    global $woocommerce;
                    $methods[] = 'WC_MULTISAFEPAY_MASTERCARD';
            ...
            // Start 
            new WC_MULTISAFEPAY_MASTERCARD();
        }
